	    ...
	    ?>
		    ...
		    <div class="row">
				...
				<?php
					...
					if(($_SESSION['uac'] !== 'PERUSAHAAN' )&&($_SESSION['uac'] !== 'ADMIN' ))
					{ 
						if ($tgl_skr >= $tgl_akhir)
							{
								echo '<div class="alert alert-danger">Lowongan pekerjaan ini sudah tidak berlaku!</div>';	
							} 
							else 
							{
            ...
            <h5 class="title-entry"> Deskripsi & Kualifikasi </h5>
				<?php echo $data['desk_job']; ?>
              	<hr>
						...
						<a href="?p=home" class="btn btn-primary btn-md">Kembali</a><?php } ?>
