...
<div class="btn-group" role="group" aria-label="...">
    ...
    <a href="?p=admin.list_job" type="button" title="Refresh" class="btn btn-default"><i class="fa fa-refresh"></i> Refresh</a>
</div>
            ...
            <table class="table table-bordered table-hover" id="dataTables-example">
                ...
                <tbody>
                    ...
                    <tr class="odd gradeX">
                        ...
                        <div class="btn-group" role="group" aria-label="...">
                        <a class="btn btn-default btn-xs" title="Lihat Detail" href="?p=admin.detail_job&id=<?php echo $data['id_job']; ?>" ><i class="fa fa-bars fa-fw"></i></a>
