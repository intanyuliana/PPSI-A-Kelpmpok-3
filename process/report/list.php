    ...
    <div class="row">
        <div class="col-lg-8">
            ...
            <div class="panel-heading">Report Perusahaan</div>
                ...
                <form class="form-horizantal" role="form" style="margin-top: 10px;" action="print.php?p=report.perusahaan" target="_blank" id="defaultForm" method="post" enctype="multipart/form-data">
            ...
            <div class="panel-heading">Report Pelamar</div>
                ...
                <form class="form-horizantal" role="form" style="margin-top: 10px;" action="print.php?p=report.pelamar" target="_blank" id="defaultForm" method="post" enctype="multipart/form-data">
